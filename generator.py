...
#    plt.annotate(f'{max_gain_frequency:.2f}', (max_gain_frequency, max_gain_value), textcoords="offset points", xytext=(0,20), ha='center') 
...
#    plt.annotate(f'{corner_freq:.2f}', (corner_freq, gain.iloc[corner_freq_index]), textcoords="offset points", xytext=(-30,50), ha='center')
